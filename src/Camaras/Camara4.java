...
public class Camara4 extends javax.swing.JFrame {
    ...
    public Camara4() {
        ...
        Notification obj = new  Notification(this, WindowPosition.TOPRIGHT, 0, 0, 900000000);
 ...
 protected volatile boolean runnable = false;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Camara4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
