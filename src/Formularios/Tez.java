 ...
 * @author hp
 */
public class Tez extends javax.swing.JFrame {

    //Variable pública
    String cod_tez;
    /**
     * Creates new form Tez
     */
    public Tez() {
        initComponents();
    ...
    public void mthConsulta(){
        ResultSet res;
        Mto_Tez obj = new Mto_Tez();
        DefaultTableModel dtm = (DefaultTableModel)jTable1.getModel();
        dtm.setRowCount(0);
        res = obj.Consulta();
        dtm.setColumnIdentifiers(new Object[]{"Codigo", "Tez"});
        try{
            while(res.next()){
                Vector v = new Vector();
                v.add(res.getInt(1));
    ...
    private void initComponents() {
        ...
        lbl_usuario7.setText("GESTION DE TEZ DE RECLUSOS");
        panel_configuracion1.add(lbl_usuario7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 290, 30));
        ...
        panel_configuracion1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 220, 180));
        ...
        panel_configuracion1.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 210, -1, 90));
        ...
        panel_configuracion1.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, -1, 90));
        ...
        panel_configuracion1.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, -1, 80));
        ...
        panel_configuracion1.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, 90));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panel_configuracion1, javax.swing.GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(panel_configuracion1, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel44MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel44MouseClicked
        if (jTextField2.getText().equals("") || cod_tez == null){
            ...
            obj.setTez(jTextField2.getText());
            obj.setCodigo(Integer.parseInt(cod_tez));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tez.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
